...
model = rstan::stan_model("../hockey_stick_hyperprior_poisson.stan")
...
# Poisson likelihood 14 days
saveRDS(fit, paste("./model_full_rstan_var_revised_poisson_14.rds", sep = ""))
...
predicted = my_posterior_predict(fit, county_train, type="decrease", lag=14, eval_pre = FALSE)
